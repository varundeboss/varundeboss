"""
Django settings for varundeboss project.
...
SECRET_KEY = 'pg_hxu71ah#lb%6pl8b-7%#pzph76_@ne965deu!o#8emqu*9*'
...
WSGI_APPLICATION = 'varundeboss.wsgi.application'
